...
import SingleCurriculamThree from "./CurriculamThree";

import curriculam from "../../data/curriculum.json";

const CurriculamActivities = () => {
    ...
    const filteredCourses =
        category === "all"
            ? curriculam
            : curriculam.filter((course) => course.category.toLowerCase() === category);
...
export default CurriculamActivities;
