...
const SingleCurriculumList = (props) => {
    const {
            ...
            <div className="inner-course">
                ...
                <div className="case-content">
                    ...
                    <h4 className="case-title">
                        <Link
                            to={`/course/${id}`}>{title ? title : 'The Most Complete Design Thinking Course On The Market.'}</Link>
                    </h4>
...
export default SingleCurriculumList