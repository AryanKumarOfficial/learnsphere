...
import SingleOlympiadThree from "./OlympiadActivitesThree"
...
const OlympiadActivitesGridMain = () => {
    ...
    const filteredCourses =
        category === "all"
            ? olympiad
            : olympiad.filter((course) => course.category.toLowerCase() === category);
                ...
                <div className="row align-items-center back-vertical-middle shorting__course mb-50">
                    ...
                    <div className="col-md-10 text-right">
                        <select className="from-control category" onChange={handleChangeCategory}>
                            ...
                            <option value="Computer Science Olympiad">Computer Science Olympiad</option>
                            <option value="Language and Literature Olympiad">Language and Literature Olympiad</option>
                            <option value="General Knowledge Olympiad">General Knowledge Olympiad</option>
                            <option value="Robotics Olympiad">Robotics Olympiad</option>
                            <option value="Environmental Science Olympiad">Environmental Science Olympiad</option>
                            <option value="Space Science Olympiad">Space Science Olympiad</option>
                            <option value="Astronomy Olympiad">Astronomy Olympiad</option>
                            <option value="Cybersecurity Olympiad">Cybersecurity Olympiad</option>
