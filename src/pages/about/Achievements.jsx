            ...
            <div className="react-blog__area blog__area pt---90 pb---120">
                <div className="container blog__width pb---120">
                    <div className="react__title__section text-center">
                        <h6 className="react__subtitle wow animate__fadeInUp" data-wow-duration="0.3s">Top Achievements.</h6>
                        <h2 className="react__tittle wow animate__fadeInUp" data-wow-duration="0.5s"> Celebrating our excellence in Academics, Sports, and Innovation.</h2>
                    </div>
                    <div className="row">
