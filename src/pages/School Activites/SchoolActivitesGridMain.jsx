...
import SchoolActivitesThree from "./SchoolActivitesThree";

import schoolactivities from "../../data/schoolactivities.json";

const SchoolActivitesGridMain = () => {
    ...
    const filteredCourses =
        category === "all"
            ? schoolactivities
            : schoolactivities.filter((course) => course.category.toLowerCase() === category);
...
export default SchoolActivitesGridMain;
