...
const FooterTwo = (props) => {
    const {footerLogo, footerClass, ctaSubtitle, ctaTitle, ctaBtn, isCta} = props;
    return (
        <>
                            ...
                            <div className="footer-top-cta wow animate__fadeInUp" data-wow-duration="0.6s">
                                <div className="row">
                                    ...
                                    <div className="col-lg-5 text-right">
                                        <Link to="#">{ctaBtn ? ctaBtn : 'Go To FAQ'}
                            ...
                            <div className="col-lg-3 md-mb-30">
                                <div className="footer-widget footer-widget-1">
                                    <div className="footer-logo white">
                                        <Link to="index.html" className="logo-text"> <img
                                            src={footerLogo ? footerLogo : Logo} alt="logo"/>
                                        </Link>
                                    </div>
                                    ...
                                    <ul className="footer-address">
                                        ...
                                        <li>
                                            ...
                                            <a href="mailto:info@iqnaut.com"> info@iqnaut.com </a></li>
                                    </ul>
                                </div>
                            </div>
                            <div className="col-lg-3 md-mb-30">
