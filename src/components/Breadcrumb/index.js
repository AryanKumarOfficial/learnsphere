...
const Breadcrumb = (props) => {
    const {pageTitle, img} = props;

    return (
        <div className="react-breadcrumbs">
            <div className="breadcrumbs-wrap">
                <img className="desktop" src={img ? img : breadcrumbsImg} alt="Breadcrumbs"/>
                <img className="mobile" src={img ? img : breadcrumbsImg} alt="Breadcrumbs"/>
